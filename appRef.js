...
// const graphQlSchema = require("@epictetus/server/graphql/schema");
// const graphQlResolvers = require("@epictetus/server/graphql/resolvers");
// const multer  = require('multer');
// const upload = multer({ dest: 'uploads/' });
// const myFile = require("@epictetus/server/utils/gameController")
//
...
//
// appRef.use(bodyParser.json())
//
// appRef.use("/graphql", graphqlHTTP({
//     schema: graphQlSchema,
//     rootValue: graphQlResolvers,
//     graphiql: true
// }))
//
// appRef.get("/upload", (req, res, next) => {
//     res.sendFile("/Users/jackheaton/Documents/code_projects/chess-opening-book/server/index.html")
// })
//
// appRef.post('/upload', upload.single("chessGame"), myFile.fileUpload)
//
